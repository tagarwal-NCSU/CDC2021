...
```{r}
SVI = SVI %>%
        mutate(E_AGE25 = round(E_NOHSDP / (EP_NOHSDP/100)), #Number of people 25+
               E_AGE16 = round(E_UNEMP / (EP_UNEMP/100)), #Number of people 16+
               E_AGE5 = round(E_LIMENG / (EP_LIMENG/100)), #Number of people 5+
               E_NOINST = round(E_DISABL / (EP_DISABL/100)), #Number of people not in an institution
               E_OCCHU = round(E_CROWD / (EP_CROWD/100))) #Number of occupied housing units
```
